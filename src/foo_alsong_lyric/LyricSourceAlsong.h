...
{
private:
	static DWORD GetFileHash(const metadb_handle_ptr &track, CHAR *Hash);
...
public:
	...
	static DWORD Save(const metadb_handle_ptr &track, const std::string &Artist, const std::string &Title, const std::string &RawLyric, const std::string &Album, const std::string &Registrant, int nInfoID = 0);
