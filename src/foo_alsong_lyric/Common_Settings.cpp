...
const GUID guid_cfg_window_enabled = 
{ 0x44eefa62, 0x996e, 0x4480, { 0xaa, 0x72, 0x98, 0xef, 0xb6, 0xf0, 0xcd, 0xd2 } };
cfg_bool cfg_enabled(guid_cfg_window_enabled, false);

const GUID guid_cfg_topmost = // {337F0BB2-5A5B-4bd5-A845-6C146F887838}
{ 0x337f0bb2, 0x5a5b, 0x4bd5, { 0xa8, 0x45, 0x6c, 0x14, 0x6f, 0x88, 0x78, 0x38 } };
cfg_bool cfg_topmost(guid_cfg_topmost, false);

const GUID guid_cfg_popup_window_placement = 
...
static const GUID guid_cfg_outer_layered = // {F2CC0F3A-735F-46b9-8FA2-6B8313A69B2C}
